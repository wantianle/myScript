...
def menu():
    ...
    choices = [
        ...
        Choice(title="[仅同步] 同步本地 docker 环境", value="5"),
        Choice(title="[仅回播] 手动或者自动回播数据", value="6"),
        Choice(title="[进容器] 交互式进 docker bash", value="7"),
    ...
    menu_map = {
        ...
        "6": lambda: workflow.play_flow(session),
        "7": lambda: session.runner.into_docker(),
