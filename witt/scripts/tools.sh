...
cp --update=none "${BASH_SOURCE[0]%/*}/../config/customized_20260403.multiviz.yaml" "$MDRIVE_ROOT/"
docker exec -d "$CONTAINER" bash -c "/mdrive/mdrive/bin/mdrive_multiviz -d /mdrive/customized_20260403.multiviz.yaml"
